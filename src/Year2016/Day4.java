...
public class Day4 {
    ...
    static void parseLine(String line) {
        ...
        List<Map.Entry<Character, Integer>> list = entriesSortedByValues(map);

        String five = "";
        five += list.get(0).getKey();
        five += list.get(1).getKey();
        five += list.get(2).getKey();
        five += list.get(3).getKey();
        five += list.get(4).getKey();
    ...
    public static void main(String[] args) {
        String input = "fubrjhqlf-edvnhw-dftxlvlwlrq-803[wjvzd]\n" +
