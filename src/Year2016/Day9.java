...
public class Day9 {
    ...
    static boolean isCompressed(String in) {
        for (int i = 0; i < in.length(); i++) {
            char c = in.charAt(i);
            if (c == '(' ) return true;
        }
